...
public class MainActivityFour extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mainactivityfour_layout);
    ...
    private void setUI(){
        ...
        TabAdapterFour tabAdapter = new TabAdapterFour(fragmentManager, 2);
    ...
    public void youtubefour (View view){
        Intent intent =  new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=B2rX21Sti80"));
