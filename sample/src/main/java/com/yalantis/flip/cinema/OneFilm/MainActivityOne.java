...
public class MainActivityOne extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mainactivityone_layout);
    ...
    private void setUI() {
        ...
        TabAdapterOne tabAdapter = new TabAdapterOne(fragmentManager, 2);
    ...
    public void youtubeone(View view) {
        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=CgP1xAeVOVw"));
