...
public class MainActivityThree extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mainactivitythree_layout);
    ...
    private void setUI(){
        ...
        TabAdapterThree tabAdapter = new TabAdapterThree(fragmentManager, 2);
    ...
    public void youtubethree (View view){
        Intent intent =  new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=gnOaMlQqoy0"));
